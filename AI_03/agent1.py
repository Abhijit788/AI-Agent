...
while True:
    ...
    while True:
        # Calling local Ollama instead of Gemini API
        ...
        # Regular expression fix for multi-line or extra JSON parsing issue
        ...
        if match:
            ...
            try:
                ...
                print("⚠️ Failed to parse JSON:", json_str)
                continue
        else:
            print("⚠️ No valid JSON object found:", raw_result)
            continue
